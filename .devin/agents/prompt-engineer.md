...
description: >-
  Master diagnostic evaluator & prompt engineer: run-failure diagnosis, GEPA mutations, prompt A/Bs across the llm-entity-extraction + llm-mailroom surfaces, plateau vs overfit decisions.
allowed-tools:
  - read
  - grep
  - glob
...
[PROMPT_ENGINEER_GEPA_PROVENANCE.md](../../.opencode/agents/PROMPT_ENGINEER_GEPA_PROVENANCE.md)).
