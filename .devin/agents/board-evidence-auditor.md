---
name: board-evidence-auditor
description: >-
  Board & repo auditor: verifies board card claims against shipped evidence, audits modules for TODOs/incomplete work, opens issues/DMR cards for discrepancies, maintains STATE.md audit trail.
---
