...
|---|---|---|---|---|---|
| DMR-020 | `in_progress` | Make the vLLM and Modal specialist agents callable as primary agents as well as subagents in this repo: set `mode: all` in `.opencode/agents/{vllm,modal}-specialist.md`, verify with `opencode agent list`, and update the roster docs/wiki. | opencode (deepseek-v4-flash-vision-exp) 2026-09-09 | [#25](https://github.com/LLM-Mailroom-Services/Digital-Mailroom/issues/25) | — |
