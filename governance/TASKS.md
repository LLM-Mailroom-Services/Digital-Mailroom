...
|---|---|---|---|---|---|
| DMR-010 | `in_progress` | HUB → DMR open-issue sync: mirror the 8 still-open HUB cards (HUB-044/064/054/062/042/020/061/036) onto the DMR board with synced issues + cross-links; HUB-006 reviewed and skipped (no equivalent surface in this codebase). | opencode (deepseek-v4-flash-vision-exp) 2026-09-09 | [#15](https://github.com/LLM-Mailroom-Services/Digital-Mailroom/issues/15) | — |
