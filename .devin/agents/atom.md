...
name: atom
description: >-
  Docs & board specialist: READMEs/wikis/changelogs, doc-drift detection, Kanban board upkeep (governance/TASKS.md), inter-agent coordination, repo restructuring docs.
---
