...
- `build_graph.py` also handles:
  ...
  - **Chunked extraction** (`_run_chunked_extraction`): every live specialist (contracts, corporate records, correspondence, insurance). Window size is capped at the agent's `max_input_chars`.
