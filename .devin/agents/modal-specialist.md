...
description: >-
  Modal compute specialist: Modal apps/functions/cls/server, Images, Volumes, Secrets, Sandboxes, GPU selection & cost, scale-to-zero/cold-start tuning, modal serve/deploy/run. Verifies current SDK docs first.
---
