...
| `docclass_merged.jsonl` (+ `docclass_merged.manifest.json`) | 700-row merged docclass corpus (CUAD 509 + MAUD 152 + S-1 39) | [mailroom-dataset](https://huggingface.co/datasets/Lucius-Morningstar/mailroom-dataset) |
